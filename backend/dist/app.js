...
//
app.use('/api/documentos', AuxAuthMiddleware, AuthAdmMiddleware, documentosRoutes);
//
app.use('/api/licencias', AuxAuthMiddleware, AuthAdmMiddleware, licenciasRoutes);
//
app.use('/api/personas', AuxAuthMiddleware, AuthAdmMiddleware, personasRoutes);
//
app.use('/api/refueling',
// antiguamente 'tanqueos'...
AuxAuthMiddleware, tanqueosRoutes);
//
app.use('/api/usuarios', AuxAuthMiddleware, AuthAdmMiddleware, usuariosRoutes);
//
app.use('/api/vehiculos', AuxAuthMiddleware, AuthAdmMiddleware, vehiculosRoutes);
//

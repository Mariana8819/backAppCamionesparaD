...
export const getAllPersonas = async (req, res) => {
  try {
    ...
    if (!personas) return res.status(404).json({
...
export const deletePersona = async (req, res) => {
  try {
    ...
    const findPersona = await Persona.findOne({
      cedula: Number(cedula)
    });

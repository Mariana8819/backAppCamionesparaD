...
import { encrypted } from '../authentication/passwords/encrypted.js';
...
export const getUsuario = async (req, res) => {
  try {
    ...
    if (!findUsuario) return res.status(404).json({
...
export const updateUsuario = async (req, res) => {
  try {
    ...
    const updateUser = await Usuario.findOneAndUpdate(filter, {
      $set: updateData
    }, {
      new: true
